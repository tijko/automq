...
public class NetworkInUsageUsageDistributionGoal extends AbstractNetworkUsageDistributionGoal {
    public static final String NAME = NetworkInUsageUsageDistributionGoal.class.getSimpleName();
